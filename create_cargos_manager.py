...
# CargosManager component content
cargos_manager_content = '''"use client";
...
os.makedirs("app/app/voyages/[id]/components", exist_ok=True)

# Write the file
with open("app/app/voyages/[id]/components/CargosManager.tsx", "w") as f:
    f.write(cargos_manager_content)

print("✅ Created CargosManager.tsx")
